function PagesLanding({ title, text }) {
  return (
    <>
      <section className="flex justify-center items-center w-[100%] h-[100vh] bg-black">
        <div className="flex flex-col gap-4 justify-center items-center text-white">
          <h1 className="font-bold box-content text-center m-6 text-5xl md:text-6xl cursor-default">{title}</h1>
